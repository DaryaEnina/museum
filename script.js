...
const marker3 = new mapboxgl.Marker({
  ...
  const marker4 = new mapboxgl.Marker({
   ...
   console.log(`
   Моя оценка - 60 баллов.
   
   Частично выполненные пункты:

   1) на карте отображаются маркеры, расположение и внешний вид маркеров ПОЧТИ соответствует макету. +2
   
   2) стиль карты ПОЧТИ соответствует макету. +2 
   
   Выполненные пункты:

   1. Слайдер Welcome +24
  ...
  5. Доп функцианал: анимация заголовков в секциях +10
  `);
